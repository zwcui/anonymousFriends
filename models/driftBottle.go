...
type DriftBottle struct {
	...
	BottleName     				string			`description:"类型名称，1普通瓶、2传递瓶、3同城瓶、4真话瓶、5暗号瓶、6提问瓶、7交往瓶、8祝愿瓶、9发泄瓶、10生日瓶、11表白瓶" json:"bottleName"`
...
//------------------------默认参数----------------------------
var PickUpDriftBottleRatio = []int{
	1,
	1,
	1,
	1,
